...
namespace AirlineReservationWebApplication.Controllers
{
    public class PrivateServiceController : Controller
    {
        ...
        public PrivateServiceController(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        public IActionResult CreatePrivateService(PassengerViewModel obj)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult UpdatePrivateService(PassengerViewModel obj)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult DeletePrivateService(PassengerViewModel obj)
        {
